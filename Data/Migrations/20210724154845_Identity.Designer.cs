...
namespace DutchThreat.Migrations
{
    ...
    [Migration("20210724154845_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchThreat.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 7, 24, 15, 48, 45, 646, DateTimeKind.Utc).AddTicks(2099),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DutchThreat.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DutchThreat.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
